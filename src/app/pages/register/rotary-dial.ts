class RotaryDial {
  ...
  private draw(): void {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      this.c.fillText(n.toString(), x, y + this.size * 0.02);

      this.c.strokeText(n.toString(), x, y + this.size * 0.02);
    }
  ...
  private isClicking(e: MouseEvent | TouchEvent): void {
    e.preventDefault();
  ...
  private getPos(e: MouseEvent | TouchEvent): { x: number; y: number } {
    ...
    if (e instanceof TouchEvent) {
      ...
      x = (e as MouseEvent).offsetX * _x;

      y = (e as MouseEvent).offsetY * _y;
    }
  ...
  private rotate(e: MouseEvent | TouchEvent): void {
